"""Tests for My Projects/Alzheimer/install.py -- run against a throwaway settings file, never
the real .claude/settings.local.json.

Run: python -m pytest "My Projects/Alzheimer/tests/test_install.py" -q
"""
